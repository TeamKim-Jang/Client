...
const SellBoard = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "매도 요청 중 오류가 발생했습니다.");
  ...
  return (
    <div style={{ padding: "20px", textAlign: "center", fontFamily: "Arial, sans-serif" }}>
      ...
      <p style={{ fontSize: "16px", color: "#777", marginBottom: "20px" }}>몇 주 파시겠어요?</p>
      <div
        style={{
          fontSize: "32px",
          fontWeight: "bold",
      ...
      {success && <p style={{ color: "green", marginBottom: "20px" }}>매도 성공!</p>}
      <button
        style={{
          padding: "15px 30px",
          fontSize: "18px",
